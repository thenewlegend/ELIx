...
<style>
  ...
  .m3-container {
    ...
    align-items: flex-start; /* Changed from center to flex-start to prevent clipping */
    min-height: 100vh;
    padding: 80px 16px 16px 16px; /* Added top padding for navbar */
  ...
  .m3-card {
    ...
    /* transition: height 0.3s ease; Removed to prevent issues with dynamic content */
    margin-bottom: 24px; /* Add margin for scrolling */
  }
