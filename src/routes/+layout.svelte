<script>
	...
	import { vibrateHeavy, vibrateMedium } from '$lib/utils/haptics.js';
...
<nav class="m3-navbar">
	<a href="/" class="app-brand-link" aria-label="ELI-X Home" onclick={() => vibrateHeavy()}>
	...
	<button 
		...
		onclick={() => { vibrateHeavy(); settingsOpen = true; }}
		aria-label="Settings"
